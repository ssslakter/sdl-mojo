...
fn get_num_audio_drivers() -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn () -> c_int]("SDL_GetNumAudioDrivers")()
...
fn get_audio_driver(index: c_int) -> Ptr[c_char, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn (index: c_int) -> Ptr[c_char, mut=False]]("SDL_GetAudioDriver")(index)
...
fn get_current_audio_driver() -> Ptr[c_char, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn () -> Ptr[c_char, mut=False]]("SDL_GetCurrentAudioDriver")()
...
fn get_audio_playback_devices(count: Ptr[c_int, mut=True]) -> Ptr[AudioDeviceID, mut=True]:
    ...
    return _get_sdl_handle()[].get_function[fn (count: Ptr[c_int, mut=True]) -> Ptr[AudioDeviceID, mut=True]]("SDL_GetAudioPlaybackDevices")(count)
...
fn get_audio_recording_devices(count: Ptr[c_int, mut=True], out ret: Ptr[AudioDeviceID, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (count: Ptr[c_int, mut=True]) -> Ptr[AudioDeviceID, mut=True]]("SDL_GetAudioRecordingDevices")(count)
    if not ret:
...
fn get_audio_device_name(devid: AudioDeviceID, out ret: Ptr[c_char, mut=False]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (devid: AudioDeviceID) -> Ptr[c_char, mut=False]]("SDL_GetAudioDeviceName")(devid)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn get_audio_device_format(devid: AudioDeviceID, spec: Ptr[AudioSpec, mut=True], sample_frames: Ptr[c_int, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (devid: AudioDeviceID, spec: Ptr[AudioSpec, mut=True], sample_frames: Ptr[c_int, mut=True]) -> Bool]("SDL_GetAudioDeviceFormat")(devid, spec, sample_frames)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn get_audio_device_channel_map(devid: AudioDeviceID, count: Ptr[c_int, mut=True]) -> Ptr[c_int, mut=True]:
    ...
    return _get_sdl_handle()[].get_function[fn (devid: AudioDeviceID, count: Ptr[c_int, mut=True]) -> Ptr[c_int, mut=True]]("SDL_GetAudioDeviceChannelMap")(devid, count)
...
fn open_audio_device(devid: AudioDeviceID, spec: Ptr[AudioSpec, mut=False]) -> AudioDeviceID:
    ...
    return _get_sdl_handle()[].get_function[fn (devid: AudioDeviceID, spec: Ptr[AudioSpec, mut=False]) -> AudioDeviceID]("SDL_OpenAudioDevice")(devid, spec)
...
fn is_audio_device_physical(devid: AudioDeviceID) -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn (devid: AudioDeviceID) -> Bool]("SDL_IsAudioDevicePhysical")(devid)
...
fn is_audio_device_playback(devid: AudioDeviceID) -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn (devid: AudioDeviceID) -> Bool]("SDL_IsAudioDevicePlayback")(devid)
...
fn pause_audio_device(devid: AudioDeviceID) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (devid: AudioDeviceID) -> Bool]("SDL_PauseAudioDevice")(devid)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn resume_audio_device(devid: AudioDeviceID) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (devid: AudioDeviceID) -> Bool]("SDL_ResumeAudioDevice")(devid)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn audio_device_paused(devid: AudioDeviceID) -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn (devid: AudioDeviceID) -> Bool]("SDL_AudioDevicePaused")(devid)
...
fn get_audio_device_gain(devid: AudioDeviceID) -> c_float:
    ...
    return _get_sdl_handle()[].get_function[fn (devid: AudioDeviceID) -> c_float]("SDL_GetAudioDeviceGain")(devid)
...
fn set_audio_device_gain(devid: AudioDeviceID, gain: c_float) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (devid: AudioDeviceID, gain: c_float) -> Bool]("SDL_SetAudioDeviceGain")(devid, gain)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn close_audio_device(devid: AudioDeviceID) -> None:
    ...
    return _get_sdl_handle()[].get_function[fn (devid: AudioDeviceID) -> None]("SDL_CloseAudioDevice")(devid)
...
fn bind_audio_streams(devid: AudioDeviceID, streams: Ptr[AudioStream, mut=True], num_streams: c_int) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (devid: AudioDeviceID, streams: Ptr[AudioStream, mut=True], num_streams: c_int) -> Bool]("SDL_BindAudioStreams")(devid, streams, num_streams)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn bind_audio_stream(devid: AudioDeviceID, stream: Ptr[AudioStream, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (devid: AudioDeviceID, stream: Ptr[AudioStream, mut=True]) -> Bool]("SDL_BindAudioStream")(devid, stream)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn unbind_audio_streams(streams: Ptr[AudioStream, mut=True], num_streams: c_int) -> None:
    ...
    return _get_sdl_handle()[].get_function[fn (streams: Ptr[AudioStream, mut=True], num_streams: c_int) -> None]("SDL_UnbindAudioStreams")(streams, num_streams)
...
fn unbind_audio_stream(stream: Ptr[AudioStream, mut=True]) -> None:
    ...
    return _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True]) -> None]("SDL_UnbindAudioStream")(stream)
...
fn get_audio_stream_device(stream: Ptr[AudioStream, mut=True]) -> AudioDeviceID:
    ...
    return _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True]) -> AudioDeviceID]("SDL_GetAudioStreamDevice")(stream)
...
fn create_audio_stream(src_spec: Ptr[AudioSpec, mut=False], dst_spec: Ptr[AudioSpec, mut=False], out ret: Ptr[AudioStream, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (src_spec: Ptr[AudioSpec, mut=False], dst_spec: Ptr[AudioSpec, mut=False]) -> Ptr[AudioStream, mut=True]]("SDL_CreateAudioStream")(src_spec, dst_spec)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn get_audio_stream_properties(stream: Ptr[AudioStream, mut=True]) -> PropertiesID:
    ...
    return _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True]) -> PropertiesID]("SDL_GetAudioStreamProperties")(stream)
...
fn get_audio_stream_format(stream: Ptr[AudioStream, mut=True], src_spec: Ptr[AudioSpec, mut=True], dst_spec: Ptr[AudioSpec, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True], src_spec: Ptr[AudioSpec, mut=True], dst_spec: Ptr[AudioSpec, mut=True]) -> Bool]("SDL_GetAudioStreamFormat")(stream, src_spec, dst_spec)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn set_audio_stream_format(stream: Ptr[AudioStream, mut=True], src_spec: Ptr[AudioSpec, mut=False], dst_spec: Ptr[AudioSpec, mut=False]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True], src_spec: Ptr[AudioSpec, mut=False], dst_spec: Ptr[AudioSpec, mut=False]) -> Bool]("SDL_SetAudioStreamFormat")(stream, src_spec, dst_spec)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn get_audio_stream_frequency_ratio(stream: Ptr[AudioStream, mut=True]) -> c_float:
    ...
    return _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True]) -> c_float]("SDL_GetAudioStreamFrequencyRatio")(stream)
...
fn set_audio_stream_frequency_ratio(stream: Ptr[AudioStream, mut=True], ratio: c_float) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True], ratio: c_float) -> Bool]("SDL_SetAudioStreamFrequencyRatio")(stream, ratio)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn get_audio_stream_gain(stream: Ptr[AudioStream, mut=True]) -> c_float:
    ...
    return _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True]) -> c_float]("SDL_GetAudioStreamGain")(stream)
...
fn set_audio_stream_gain(stream: Ptr[AudioStream, mut=True], gain: c_float) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True], gain: c_float) -> Bool]("SDL_SetAudioStreamGain")(stream, gain)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn get_audio_stream_input_channel_map(stream: Ptr[AudioStream, mut=True], count: Ptr[c_int, mut=True]) -> Ptr[c_int, mut=True]:
    ...
    return _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True], count: Ptr[c_int, mut=True]) -> Ptr[c_int, mut=True]]("SDL_GetAudioStreamInputChannelMap")(stream, count)
...
fn get_audio_stream_output_channel_map(stream: Ptr[AudioStream, mut=True], count: Ptr[c_int, mut=True]) -> Ptr[c_int, mut=True]:
    ...
    return _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True], count: Ptr[c_int, mut=True]) -> Ptr[c_int, mut=True]]("SDL_GetAudioStreamOutputChannelMap")(stream, count)
...
fn set_audio_stream_input_channel_map(stream: Ptr[AudioStream, mut=True], chmap: Ptr[c_int, mut=False], count: c_int) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True], chmap: Ptr[c_int, mut=False], count: c_int) -> Bool]("SDL_SetAudioStreamInputChannelMap")(stream, chmap, count)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn set_audio_stream_output_channel_map(stream: Ptr[AudioStream, mut=True], chmap: Ptr[c_int, mut=False], count: c_int) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True], chmap: Ptr[c_int, mut=False], count: c_int) -> Bool]("SDL_SetAudioStreamOutputChannelMap")(stream, chmap, count)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn put_audio_stream_data(stream: Ptr[AudioStream, mut=True], buf: Ptr[NoneType, mut=False], len: c_int) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True], buf: Ptr[NoneType, mut=False], len: c_int) -> Bool]("SDL_PutAudioStreamData")(stream, buf, len)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn get_audio_stream_data(stream: Ptr[AudioStream, mut=True], buf: Ptr[NoneType, mut=True], len: c_int) -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True], buf: Ptr[NoneType, mut=True], len: c_int) -> c_int]("SDL_GetAudioStreamData")(stream, buf, len)
...
fn get_audio_stream_available(stream: Ptr[AudioStream, mut=True]) -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True]) -> c_int]("SDL_GetAudioStreamAvailable")(stream)
...
fn get_audio_stream_queued(stream: Ptr[AudioStream, mut=True]) -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True]) -> c_int]("SDL_GetAudioStreamQueued")(stream)
...
fn flush_audio_stream(stream: Ptr[AudioStream, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True]) -> Bool]("SDL_FlushAudioStream")(stream)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn clear_audio_stream(stream: Ptr[AudioStream, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True]) -> Bool]("SDL_ClearAudioStream")(stream)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn pause_audio_stream_device(stream: Ptr[AudioStream, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True]) -> Bool]("SDL_PauseAudioStreamDevice")(stream)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn resume_audio_stream_device(stream: Ptr[AudioStream, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True]) -> Bool]("SDL_ResumeAudioStreamDevice")(stream)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn audio_stream_device_paused(stream: Ptr[AudioStream, mut=True]) -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True]) -> Bool]("SDL_AudioStreamDevicePaused")(stream)
...
fn lock_audio_stream(stream: Ptr[AudioStream, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True]) -> Bool]("SDL_LockAudioStream")(stream)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn unlock_audio_stream(stream: Ptr[AudioStream, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True]) -> Bool]("SDL_UnlockAudioStream")(stream)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn set_audio_stream_get_callback(stream: Ptr[AudioStream, mut=True], callback: AudioStreamCallback, userdata: Ptr[NoneType, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True], callback: AudioStreamCallback, userdata: Ptr[NoneType, mut=True]) -> Bool]("SDL_SetAudioStreamGetCallback")(stream, callback, userdata)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn set_audio_stream_put_callback(stream: Ptr[AudioStream, mut=True], callback: AudioStreamCallback, userdata: Ptr[NoneType, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True], callback: AudioStreamCallback, userdata: Ptr[NoneType, mut=True]) -> Bool]("SDL_SetAudioStreamPutCallback")(stream, callback, userdata)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn destroy_audio_stream(stream: Ptr[AudioStream, mut=True]) -> None:
    ...
    return _get_sdl_handle()[].get_function[fn (stream: Ptr[AudioStream, mut=True]) -> None]("SDL_DestroyAudioStream")(stream)
...
fn open_audio_device_stream(devid: AudioDeviceID, spec: Ptr[AudioSpec, mut=False], callback: AudioStreamCallback, userdata: Ptr[NoneType, mut=True], out ret: Ptr[AudioStream, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (devid: AudioDeviceID, spec: Ptr[AudioSpec, mut=False], callback: AudioStreamCallback, userdata: Ptr[NoneType, mut=True]) -> Ptr[AudioStream, mut=True]]("SDL_OpenAudioDeviceStream")(devid, spec, callback, userdata)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn set_audio_postmix_callback(devid: AudioDeviceID, callback: AudioPostmixCallback, userdata: Ptr[NoneType, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (devid: AudioDeviceID, callback: AudioPostmixCallback, userdata: Ptr[NoneType, mut=True]) -> Bool]("SDL_SetAudioPostmixCallback")(devid, callback, userdata)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn load_wav_io(src: Ptr[IOStream, mut=True], closeio: Bool, spec: Ptr[AudioSpec, mut=True], audio_buf: Ptr[Ptr[UInt8, mut=True], mut=True], audio_len: Ptr[UInt32, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (src: Ptr[IOStream, mut=True], closeio: Bool, spec: Ptr[AudioSpec, mut=True], audio_buf: Ptr[Ptr[UInt8, mut=True], mut=True], audio_len: Ptr[UInt32, mut=True]) -> Bool]("SDL_LoadWAV_IO")(src, closeio, spec, audio_buf, audio_len)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn load_wav(var path: String, spec: Ptr[AudioSpec, mut=True], audio_buf: Ptr[Ptr[UInt8, mut=True], mut=True], audio_len: Ptr[UInt32, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (path: Ptr[c_char, mut=False], spec: Ptr[AudioSpec, mut=True], audio_buf: Ptr[Ptr[UInt8, mut=True], mut=True], audio_len: Ptr[UInt32, mut=True]) -> Bool]("SDL_LoadWAV")(path.unsafe_cstr_ptr(), spec, audio_buf, audio_len)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn mix_audio(dst: Ptr[UInt8, mut=True], src: Ptr[UInt8, mut=False], format: AudioFormat, len: UInt32, volume: c_float) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (dst: Ptr[UInt8, mut=True], src: Ptr[UInt8, mut=False], format: AudioFormat, len: UInt32, volume: c_float) -> Bool]("SDL_MixAudio")(dst, src, format, len, volume)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn convert_audio_samples(src_spec: Ptr[AudioSpec, mut=False], src_data: Ptr[UInt8, mut=False], src_len: c_int, dst_spec: Ptr[AudioSpec, mut=False], dst_data: Ptr[Ptr[UInt8, mut=True], mut=True], dst_len: Ptr[c_int, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (src_spec: Ptr[AudioSpec, mut=False], src_data: Ptr[UInt8, mut=False], src_len: c_int, dst_spec: Ptr[AudioSpec, mut=False], dst_data: Ptr[Ptr[UInt8, mut=True], mut=True], dst_len: Ptr[c_int, mut=True]) -> Bool]("SDL_ConvertAudioSamples")(src_spec, src_data, src_len, dst_spec, dst_data, dst_len)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn get_audio_format_name(format: AudioFormat) -> Ptr[c_char, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn (format: AudioFormat) -> Ptr[c_char, mut=False]]("SDL_GetAudioFormatName")(format)
...
fn get_silence_value_for_format(format: AudioFormat) -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn (format: AudioFormat) -> c_int]("SDL_GetSilenceValueForFormat")(format)
