...
@fieldwise_init
struct Palette(ImplicitlyCopyable, Movable):
...
@fieldwise_init
struct PixelFormatDetails(ImplicitlyCopyable, Movable):
...
fn get_pixel_format_name(format: PixelFormat) -> Ptr[c_char, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn (format: PixelFormat) -> Ptr[c_char, mut=False]]("SDL_GetPixelFormatName")(format)
...
fn get_masks_for_pixel_format(format: PixelFormat, bpp: Ptr[c_int, mut=True], rmask: Ptr[UInt32, mut=True], gmask: Ptr[UInt32, mut=True], bmask: Ptr[UInt32, mut=True], amask: Ptr[UInt32, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (format: PixelFormat, bpp: Ptr[c_int, mut=True], rmask: Ptr[UInt32, mut=True], gmask: Ptr[UInt32, mut=True], bmask: Ptr[UInt32, mut=True], amask: Ptr[UInt32, mut=True]) -> Bool]("SDL_GetMasksForPixelFormat")(format, bpp, rmask, gmask, bmask, amask)
    if not ret:
...
fn get_pixel_format_for_masks(bpp: c_int, rmask: UInt32, gmask: UInt32, bmask: UInt32, amask: UInt32) -> PixelFormat:
    ...
    return _get_sdl_handle()[].get_function[fn (bpp: c_int, rmask: UInt32, gmask: UInt32, bmask: UInt32, amask: UInt32) -> PixelFormat]("SDL_GetPixelFormatForMasks")(bpp, rmask, gmask, bmask, amask)
...
fn get_pixel_format_details(format: PixelFormat) -> Ptr[PixelFormatDetails, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn (format: PixelFormat) -> Ptr[PixelFormatDetails, mut=False]]("SDL_GetPixelFormatDetails")(format)
...
fn create_palette(ncolors: c_int) -> Ptr[Palette, mut=True]:
    ...
    return _get_sdl_handle()[].get_function[fn (ncolors: c_int) -> Ptr[Palette, mut=True]]("SDL_CreatePalette")(ncolors)
...
fn set_palette_colors(palette: Ptr[Palette, mut=True], colors: Ptr[Color, mut=False], firstcolor: c_int, ncolors: c_int) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (palette: Ptr[Palette, mut=True], colors: Ptr[Color, mut=False], firstcolor: c_int, ncolors: c_int) -> Bool]("SDL_SetPaletteColors")(palette, colors, firstcolor, ncolors)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn destroy_palette(palette: Ptr[Palette, mut=True]) -> None:
    ...
    return _get_sdl_handle()[].get_function[fn (palette: Ptr[Palette, mut=True]) -> None]("SDL_DestroyPalette")(palette)
...
fn map_rgb(format: Ptr[PixelFormatDetails, mut=False], palette: Ptr[Palette, mut=False], r: UInt8, g: UInt8, b: UInt8) -> UInt32:
    ...
    return _get_sdl_handle()[].get_function[fn (format: Ptr[PixelFormatDetails, mut=False], palette: Ptr[Palette, mut=False], r: UInt8, g: UInt8, b: UInt8) -> UInt32]("SDL_MapRGB")(format, palette, r, g, b)
...
fn map_rgba(format: Ptr[PixelFormatDetails, mut=False], palette: Ptr[Palette, mut=False], r: UInt8, g: UInt8, b: UInt8, a: UInt8) -> UInt32:
    ...
    return _get_sdl_handle()[].get_function[fn (format: Ptr[PixelFormatDetails, mut=False], palette: Ptr[Palette, mut=False], r: UInt8, g: UInt8, b: UInt8, a: UInt8) -> UInt32]("SDL_MapRGBA")(format, palette, r, g, b, a)
...
fn get_rgb(pixel: UInt32, format: Ptr[PixelFormatDetails, mut=False], palette: Ptr[Palette, mut=False], r: Ptr[UInt8, mut=True], g: Ptr[UInt8, mut=True], b: Ptr[UInt8, mut=True]) -> None:
    ...
    return _get_sdl_handle()[].get_function[fn (pixel: UInt32, format: Ptr[PixelFormatDetails, mut=False], palette: Ptr[Palette, mut=False], r: Ptr[UInt8, mut=True], g: Ptr[UInt8, mut=True], b: Ptr[UInt8, mut=True]) -> None]("SDL_GetRGB")(pixel, format, palette, r, g, b)
...
fn get_rgba(pixel: UInt32, format: Ptr[PixelFormatDetails, mut=False], palette: Ptr[Palette, mut=False], r: Ptr[UInt8, mut=True], g: Ptr[UInt8, mut=True], b: Ptr[UInt8, mut=True], a: Ptr[UInt8, mut=True]) -> None:
    ...
    return _get_sdl_handle()[].get_function[fn (pixel: UInt32, format: Ptr[PixelFormatDetails, mut=False], palette: Ptr[Palette, mut=False], r: Ptr[UInt8, mut=True], g: Ptr[UInt8, mut=True], b: Ptr[UInt8, mut=True], a: Ptr[UInt8, mut=True]) -> None]("SDL_GetRGBA")(pixel, format, palette, r, g, b, a)
