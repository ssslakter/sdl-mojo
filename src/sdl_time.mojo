...
fn get_date_time_locale_preferences(date_format: Ptr[DateFormat, mut=True], time_format: Ptr[TimeFormat, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (date_format: Ptr[DateFormat, mut=True], time_format: Ptr[TimeFormat, mut=True]) -> Bool]("SDL_GetDateTimeLocalePreferences")(date_format, time_format)
    if not ret:
...
fn get_current_time(ticks: Ptr[Int64, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (ticks: Ptr[Int64, mut=True]) -> Bool]("SDL_GetCurrentTime")(ticks)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn time_to_date_time(ticks: Int64, dt: Ptr[DateTime, mut=True], local_time: Bool) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (ticks: Int64, dt: Ptr[DateTime, mut=True], local_time: Bool) -> Bool]("SDL_TimeToDateTime")(ticks, dt, local_time)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn date_time_to_time(dt: Ptr[DateTime, mut=False], ticks: Ptr[Int64, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (dt: Ptr[DateTime, mut=False], ticks: Ptr[Int64, mut=True]) -> Bool]("SDL_DateTimeToTime")(dt, ticks)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn time_to_windows(ticks: Int64, dw_low_date_time: Ptr[UInt32, mut=True], dw_high_date_time: Ptr[UInt32, mut=True]) -> None:
    ...
    return _get_sdl_handle()[].get_function[fn (ticks: Int64, dw_low_date_time: Ptr[UInt32, mut=True], dw_high_date_time: Ptr[UInt32, mut=True]) -> None]("SDL_TimeToWindows")(ticks, dw_low_date_time, dw_high_date_time)
...
fn time_from_windows(dw_low_date_time: UInt32, dw_high_date_time: UInt32) -> Int64:
    ...
    return _get_sdl_handle()[].get_function[fn (dw_low_date_time: UInt32, dw_high_date_time: UInt32) -> Int64]("SDL_TimeFromWindows")(dw_low_date_time, dw_high_date_time)
...
fn get_days_in_month(year: c_int, month: c_int) -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn (year: c_int, month: c_int) -> c_int]("SDL_GetDaysInMonth")(year, month)
...
fn get_day_of_year(year: c_int, month: c_int, day: c_int) -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn (year: c_int, month: c_int, day: c_int) -> c_int]("SDL_GetDayOfYear")(year, month, day)
...
fn get_day_of_week(year: c_int, month: c_int, day: c_int) -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn (year: c_int, month: c_int, day: c_int) -> c_int]("SDL_GetDayOfWeek")(year, month, day)
