...
@fieldwise_init
struct IOStreamInterface(ImplicitlyCopyable, Movable):
...
@fieldwise_init
struct IOStream(ImplicitlyCopyable, Movable):
...
fn io_from_file(var file: String, var mode: String) -> Ptr[IOStream, mut=True]:
    ...
    **NOTE**: In order to open a file as a binary file, a "b" character has to
    ...
    return _get_sdl_handle()[].get_function[fn (file: Ptr[c_char, mut=False], mode: Ptr[c_char, mut=False]) -> Ptr[IOStream, mut=True]]("SDL_IOFromFile")(file.unsafe_cstr_ptr(), mode.unsafe_cstr_ptr())
...
fn io_from_mem(mem: Ptr[NoneType, mut=True], size: c_size_t, out ret: Ptr[IOStream, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (mem: Ptr[NoneType, mut=True], size: c_size_t) -> Ptr[IOStream, mut=True]]("SDL_IOFromMem")(mem, size)
    if not ret:
...
fn io_from_const_mem(mem: Ptr[NoneType, mut=False], size: c_size_t, out ret: Ptr[IOStream, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (mem: Ptr[NoneType, mut=False], size: c_size_t) -> Ptr[IOStream, mut=True]]("SDL_IOFromConstMem")(mem, size)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn io_from_dynamic_mem(out ret: Ptr[IOStream, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn () -> Ptr[IOStream, mut=True]]("SDL_IOFromDynamicMem")()
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn open_io(iface: Ptr[IOStreamInterface, mut=False], userdata: Ptr[NoneType, mut=True], out ret: Ptr[IOStream, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (iface: Ptr[IOStreamInterface, mut=False], userdata: Ptr[NoneType, mut=True]) -> Ptr[IOStream, mut=True]]("SDL_OpenIO")(iface, userdata)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn close_io(context: Ptr[IOStream, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (context: Ptr[IOStream, mut=True]) -> Bool]("SDL_CloseIO")(context)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn get_io_properties(context: Ptr[IOStream, mut=True]) -> PropertiesID:
    ...
    return _get_sdl_handle()[].get_function[fn (context: Ptr[IOStream, mut=True]) -> PropertiesID]("SDL_GetIOProperties")(context)
...
fn get_io_status(context: Ptr[IOStream, mut=True]) -> IOStatus:
    ...
    return _get_sdl_handle()[].get_function[fn (context: Ptr[IOStream, mut=True]) -> IOStatus]("SDL_GetIOStatus")(context)
...
fn get_io_size(context: Ptr[IOStream, mut=True]) -> Int64:
    ...
    return _get_sdl_handle()[].get_function[fn (context: Ptr[IOStream, mut=True]) -> Int64]("SDL_GetIOSize")(context)
...
fn seek_io(context: Ptr[IOStream, mut=True], offset: Int64, whence: IOWhence) -> Int64:
    ...
    return _get_sdl_handle()[].get_function[fn (context: Ptr[IOStream, mut=True], offset: Int64, whence: IOWhence) -> Int64]("SDL_SeekIO")(context, offset, whence)
...
fn tell_io(context: Ptr[IOStream, mut=True]) -> Int64:
    ...
    return _get_sdl_handle()[].get_function[fn (context: Ptr[IOStream, mut=True]) -> Int64]("SDL_TellIO")(context)
...
fn read_io(context: Ptr[IOStream, mut=True], ptr: Ptr[NoneType, mut=True], size: c_size_t) -> c_size_t:
    ...
    return _get_sdl_handle()[].get_function[fn (context: Ptr[IOStream, mut=True], ptr: Ptr[NoneType, mut=True], size: c_size_t) -> c_size_t]("SDL_ReadIO")(context, ptr, size)
...
fn write_io(context: Ptr[IOStream, mut=True], ptr: Ptr[NoneType, mut=False], size: c_size_t) -> c_size_t:
    ...
    return _get_sdl_handle()[].get_function[fn (context: Ptr[IOStream, mut=True], ptr: Ptr[NoneType, mut=False], size: c_size_t) -> c_size_t]("SDL_WriteIO")(context, ptr, size)
...
fn flush_io(context: Ptr[IOStream, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (context: Ptr[IOStream, mut=True]) -> Bool]("SDL_FlushIO")(context)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn load_file_io(src: Ptr[IOStream, mut=True], datasize: Ptr[c_size_t, mut=True], closeio: Bool, out ret: Ptr[NoneType, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (src: Ptr[IOStream, mut=True], datasize: Ptr[c_size_t, mut=True], closeio: Bool) -> Ptr[NoneType, mut=True]]("SDL_LoadFile_IO")(src, datasize, closeio)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn load_file(var file: String, datasize: Ptr[c_size_t, mut=True], out ret: Ptr[NoneType, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (file: Ptr[c_char, mut=False], datasize: Ptr[c_size_t, mut=True]) -> Ptr[NoneType, mut=True]]("SDL_LoadFile")(file.unsafe_cstr_ptr(), datasize)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn save_file_io(src: Ptr[IOStream, mut=True], data: Ptr[NoneType, mut=False], datasize: c_size_t, closeio: Bool) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (src: Ptr[IOStream, mut=True], data: Ptr[NoneType, mut=False], datasize: c_size_t, closeio: Bool) -> Bool]("SDL_SaveFile_IO")(src, data, datasize, closeio)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn save_file(var file: String, data: Ptr[NoneType, mut=False], datasize: c_size_t) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (file: Ptr[c_char, mut=False], data: Ptr[NoneType, mut=False], datasize: c_size_t) -> Bool]("SDL_SaveFile")(file.unsafe_cstr_ptr(), data, datasize)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn read_u8(src: Ptr[IOStream, mut=True], value: Ptr[UInt8, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (src: Ptr[IOStream, mut=True], value: Ptr[UInt8, mut=True]) -> Bool]("SDL_ReadU8")(src, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn read_s8(src: Ptr[IOStream, mut=True], value: Ptr[Int8, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (src: Ptr[IOStream, mut=True], value: Ptr[Int8, mut=True]) -> Bool]("SDL_ReadS8")(src, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn read_u16_le(src: Ptr[IOStream, mut=True], value: Ptr[UInt16, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (src: Ptr[IOStream, mut=True], value: Ptr[UInt16, mut=True]) -> Bool]("SDL_ReadU16LE")(src, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn read_s16_le(src: Ptr[IOStream, mut=True], value: Ptr[Int16, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (src: Ptr[IOStream, mut=True], value: Ptr[Int16, mut=True]) -> Bool]("SDL_ReadS16LE")(src, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn read_u16_be(src: Ptr[IOStream, mut=True], value: Ptr[UInt16, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (src: Ptr[IOStream, mut=True], value: Ptr[UInt16, mut=True]) -> Bool]("SDL_ReadU16BE")(src, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn read_s16_be(src: Ptr[IOStream, mut=True], value: Ptr[Int16, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (src: Ptr[IOStream, mut=True], value: Ptr[Int16, mut=True]) -> Bool]("SDL_ReadS16BE")(src, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn read_u32_le(src: Ptr[IOStream, mut=True], value: Ptr[UInt32, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (src: Ptr[IOStream, mut=True], value: Ptr[UInt32, mut=True]) -> Bool]("SDL_ReadU32LE")(src, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn read_s32_le(src: Ptr[IOStream, mut=True], value: Ptr[Int32, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (src: Ptr[IOStream, mut=True], value: Ptr[Int32, mut=True]) -> Bool]("SDL_ReadS32LE")(src, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn read_u32_be(src: Ptr[IOStream, mut=True], value: Ptr[UInt32, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (src: Ptr[IOStream, mut=True], value: Ptr[UInt32, mut=True]) -> Bool]("SDL_ReadU32BE")(src, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn read_s32_be(src: Ptr[IOStream, mut=True], value: Ptr[Int32, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (src: Ptr[IOStream, mut=True], value: Ptr[Int32, mut=True]) -> Bool]("SDL_ReadS32BE")(src, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn read_u64_le(src: Ptr[IOStream, mut=True], value: Ptr[UInt64, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (src: Ptr[IOStream, mut=True], value: Ptr[UInt64, mut=True]) -> Bool]("SDL_ReadU64LE")(src, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn read_s64_le(src: Ptr[IOStream, mut=True], value: Ptr[Int64, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (src: Ptr[IOStream, mut=True], value: Ptr[Int64, mut=True]) -> Bool]("SDL_ReadS64LE")(src, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn read_u64_be(src: Ptr[IOStream, mut=True], value: Ptr[UInt64, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (src: Ptr[IOStream, mut=True], value: Ptr[UInt64, mut=True]) -> Bool]("SDL_ReadU64BE")(src, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn read_s64_be(src: Ptr[IOStream, mut=True], value: Ptr[Int64, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (src: Ptr[IOStream, mut=True], value: Ptr[Int64, mut=True]) -> Bool]("SDL_ReadS64BE")(src, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn write_u8(dst: Ptr[IOStream, mut=True], value: UInt8) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (dst: Ptr[IOStream, mut=True], value: UInt8) -> Bool]("SDL_WriteU8")(dst, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn write_s8(dst: Ptr[IOStream, mut=True], value: Int8) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (dst: Ptr[IOStream, mut=True], value: Int8) -> Bool]("SDL_WriteS8")(dst, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn write_u16_le(dst: Ptr[IOStream, mut=True], value: UInt16) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (dst: Ptr[IOStream, mut=True], value: UInt16) -> Bool]("SDL_WriteU16LE")(dst, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn write_s16_le(dst: Ptr[IOStream, mut=True], value: Int16) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (dst: Ptr[IOStream, mut=True], value: Int16) -> Bool]("SDL_WriteS16LE")(dst, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn write_u16_be(dst: Ptr[IOStream, mut=True], value: UInt16) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (dst: Ptr[IOStream, mut=True], value: UInt16) -> Bool]("SDL_WriteU16BE")(dst, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn write_s16_be(dst: Ptr[IOStream, mut=True], value: Int16) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (dst: Ptr[IOStream, mut=True], value: Int16) -> Bool]("SDL_WriteS16BE")(dst, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn write_u32_le(dst: Ptr[IOStream, mut=True], value: UInt32) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (dst: Ptr[IOStream, mut=True], value: UInt32) -> Bool]("SDL_WriteU32LE")(dst, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn write_s32_le(dst: Ptr[IOStream, mut=True], value: Int32) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (dst: Ptr[IOStream, mut=True], value: Int32) -> Bool]("SDL_WriteS32LE")(dst, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn write_u32_be(dst: Ptr[IOStream, mut=True], value: UInt32) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (dst: Ptr[IOStream, mut=True], value: UInt32) -> Bool]("SDL_WriteU32BE")(dst, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn write_s32_be(dst: Ptr[IOStream, mut=True], value: Int32) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (dst: Ptr[IOStream, mut=True], value: Int32) -> Bool]("SDL_WriteS32BE")(dst, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn write_u64_le(dst: Ptr[IOStream, mut=True], value: UInt64) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (dst: Ptr[IOStream, mut=True], value: UInt64) -> Bool]("SDL_WriteU64LE")(dst, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn write_s64_le(dst: Ptr[IOStream, mut=True], value: Int64) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (dst: Ptr[IOStream, mut=True], value: Int64) -> Bool]("SDL_WriteS64LE")(dst, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn write_u64_be(dst: Ptr[IOStream, mut=True], value: UInt64) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (dst: Ptr[IOStream, mut=True], value: UInt64) -> Bool]("SDL_WriteU64BE")(dst, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn write_s64_be(dst: Ptr[IOStream, mut=True], value: Int64) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (dst: Ptr[IOStream, mut=True], value: Int64) -> Bool]("SDL_WriteS64BE")(dst, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
