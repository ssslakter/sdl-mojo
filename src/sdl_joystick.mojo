...
fn lock_joysticks() -> None:
    ...
    return _get_sdl_handle()[].get_function[fn () -> None]("SDL_LockJoysticks")()
...
fn unlock_joysticks() -> None:
    ...
    return _get_sdl_handle()[].get_function[fn () -> None]("SDL_UnlockJoysticks")()
...
fn has_joystick() -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn () -> Bool]("SDL_HasJoystick")()
...
fn get_joysticks(count: Ptr[c_int, mut=True], out ret: Ptr[JoystickID, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (count: Ptr[c_int, mut=True]) -> Ptr[JoystickID, mut=True]]("SDL_GetJoysticks")(count)
    if not ret:
...
fn get_joystick_name_for_id(instance_id: JoystickID) -> Ptr[c_char, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> Ptr[c_char, mut=False]]("SDL_GetJoystickNameForID")(instance_id)
...
fn get_joystick_path_for_id(instance_id: JoystickID) -> Ptr[c_char, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> Ptr[c_char, mut=False]]("SDL_GetJoystickPathForID")(instance_id)
...
fn get_joystick_player_index_for_id(instance_id: JoystickID) -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> c_int]("SDL_GetJoystickPlayerIndexForID")(instance_id)
...
fn get_joystick_guid_for_id(instance_id: JoystickID) -> GUID:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> GUID]("SDL_GetJoystickGUIDForID")(instance_id)
...
fn get_joystick_vendor_for_id(instance_id: JoystickID) -> UInt16:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> UInt16]("SDL_GetJoystickVendorForID")(instance_id)
...
fn get_joystick_product_for_id(instance_id: JoystickID) -> UInt16:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> UInt16]("SDL_GetJoystickProductForID")(instance_id)
...
fn get_joystick_product_version_for_id(instance_id: JoystickID) -> UInt16:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> UInt16]("SDL_GetJoystickProductVersionForID")(instance_id)
...
fn get_joystick_type_for_id(instance_id: JoystickID) -> JoystickType:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> JoystickType]("SDL_GetJoystickTypeForID")(instance_id)
...
fn open_joystick(instance_id: JoystickID, out ret: Ptr[Joystick, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> Ptr[Joystick, mut=True]]("SDL_OpenJoystick")(instance_id)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn get_joystick_from_id(instance_id: JoystickID) -> Ptr[Joystick, mut=True]:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> Ptr[Joystick, mut=True]]("SDL_GetJoystickFromID")(instance_id)
...
fn get_joystick_from_player_index(player_index: c_int, out ret: Ptr[Joystick, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (player_index: c_int) -> Ptr[Joystick, mut=True]]("SDL_GetJoystickFromPlayerIndex")(player_index)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn attach_virtual_joystick(desc: Ptr[VirtualJoystickDesc, mut=False]) -> JoystickID:
    ...
    return _get_sdl_handle()[].get_function[fn (desc: Ptr[VirtualJoystickDesc, mut=False]) -> JoystickID]("SDL_AttachVirtualJoystick")(desc)
...
fn detach_virtual_joystick(instance_id: JoystickID) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> Bool]("SDL_DetachVirtualJoystick")(instance_id)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn is_joystick_virtual(instance_id: JoystickID) -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> Bool]("SDL_IsJoystickVirtual")(instance_id)
...
fn set_joystick_virtual_axis(joystick: Ptr[Joystick, mut=True], axis: c_int, value: Int16) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True], axis: c_int, value: Int16) -> Bool]("SDL_SetJoystickVirtualAxis")(joystick, axis, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn set_joystick_virtual_ball(joystick: Ptr[Joystick, mut=True], ball: c_int, xrel: Int16, yrel: Int16) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True], ball: c_int, xrel: Int16, yrel: Int16) -> Bool]("SDL_SetJoystickVirtualBall")(joystick, ball, xrel, yrel)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn set_joystick_virtual_button(joystick: Ptr[Joystick, mut=True], button: c_int, down: Bool) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True], button: c_int, down: Bool) -> Bool]("SDL_SetJoystickVirtualButton")(joystick, button, down)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn set_joystick_virtual_hat(joystick: Ptr[Joystick, mut=True], hat: c_int, value: UInt8) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True], hat: c_int, value: UInt8) -> Bool]("SDL_SetJoystickVirtualHat")(joystick, hat, value)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn set_joystick_virtual_touchpad(joystick: Ptr[Joystick, mut=True], touchpad: c_int, finger: c_int, down: Bool, x: c_float, y: c_float, pressure: c_float) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True], touchpad: c_int, finger: c_int, down: Bool, x: c_float, y: c_float, pressure: c_float) -> Bool]("SDL_SetJoystickVirtualTouchpad")(joystick, touchpad, finger, down, x, y, pressure)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn send_joystick_virtual_sensor_data(joystick: Ptr[Joystick, mut=True], type: SensorType, sensor_timestamp: UInt64, data: Ptr[c_float, mut=False], num_values: c_int) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True], type: SensorType, sensor_timestamp: UInt64, data: Ptr[c_float, mut=False], num_values: c_int) -> Bool]("SDL_SendJoystickVirtualSensorData")(joystick, type, sensor_timestamp, data, num_values)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn get_joystick_properties(joystick: Ptr[Joystick, mut=True]) -> PropertiesID:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True]) -> PropertiesID]("SDL_GetJoystickProperties")(joystick)
...
fn get_joystick_name(joystick: Ptr[Joystick, mut=True]) -> Ptr[c_char, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True]) -> Ptr[c_char, mut=False]]("SDL_GetJoystickName")(joystick)
...
fn get_joystick_path(joystick: Ptr[Joystick, mut=True]) -> Ptr[c_char, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True]) -> Ptr[c_char, mut=False]]("SDL_GetJoystickPath")(joystick)
...
fn get_joystick_player_index(joystick: Ptr[Joystick, mut=True]) -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True]) -> c_int]("SDL_GetJoystickPlayerIndex")(joystick)
...
fn set_joystick_player_index(joystick: Ptr[Joystick, mut=True], player_index: c_int) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True], player_index: c_int) -> Bool]("SDL_SetJoystickPlayerIndex")(joystick, player_index)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn get_joystick_guid(joystick: Ptr[Joystick, mut=True]) -> GUID:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True]) -> GUID]("SDL_GetJoystickGUID")(joystick)
...
fn get_joystick_vendor(joystick: Ptr[Joystick, mut=True]) -> UInt16:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True]) -> UInt16]("SDL_GetJoystickVendor")(joystick)
...
fn get_joystick_product(joystick: Ptr[Joystick, mut=True]) -> UInt16:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True]) -> UInt16]("SDL_GetJoystickProduct")(joystick)
...
fn get_joystick_product_version(joystick: Ptr[Joystick, mut=True]) -> UInt16:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True]) -> UInt16]("SDL_GetJoystickProductVersion")(joystick)
...
fn get_joystick_firmware_version(joystick: Ptr[Joystick, mut=True]) -> UInt16:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True]) -> UInt16]("SDL_GetJoystickFirmwareVersion")(joystick)
...
fn get_joystick_serial(joystick: Ptr[Joystick, mut=True]) -> Ptr[c_char, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True]) -> Ptr[c_char, mut=False]]("SDL_GetJoystickSerial")(joystick)
...
fn get_joystick_type(joystick: Ptr[Joystick, mut=True]) -> JoystickType:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True]) -> JoystickType]("SDL_GetJoystickType")(joystick)
...
fn get_joystick_guid_info(guid: GUID, vendor: Ptr[UInt16, mut=True], product: Ptr[UInt16, mut=True], version: Ptr[UInt16, mut=True], crc16: Ptr[UInt16, mut=True]) -> None:
    ...
    return _get_sdl_handle()[].get_function[fn (guid: GUID, vendor: Ptr[UInt16, mut=True], product: Ptr[UInt16, mut=True], version: Ptr[UInt16, mut=True], crc16: Ptr[UInt16, mut=True]) -> None]("SDL_GetJoystickGUIDInfo")(guid, vendor, product, version, crc16)
...
fn joystick_connected(joystick: Ptr[Joystick, mut=True]) -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True]) -> Bool]("SDL_JoystickConnected")(joystick)
...
fn get_joystick_id(joystick: Ptr[Joystick, mut=True]) -> JoystickID:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True]) -> JoystickID]("SDL_GetJoystickID")(joystick)
...
fn get_num_joystick_axes(joystick: Ptr[Joystick, mut=True]) -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True]) -> c_int]("SDL_GetNumJoystickAxes")(joystick)
...
fn get_num_joystick_balls(joystick: Ptr[Joystick, mut=True]) -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True]) -> c_int]("SDL_GetNumJoystickBalls")(joystick)
...
fn get_num_joystick_hats(joystick: Ptr[Joystick, mut=True]) -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True]) -> c_int]("SDL_GetNumJoystickHats")(joystick)
...
fn get_num_joystick_buttons(joystick: Ptr[Joystick, mut=True]) -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True]) -> c_int]("SDL_GetNumJoystickButtons")(joystick)
...
fn set_joystick_events_enabled(enabled: Bool) -> None:
    ...
    return _get_sdl_handle()[].get_function[fn (enabled: Bool) -> None]("SDL_SetJoystickEventsEnabled")(enabled)
...
fn joystick_events_enabled() -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn () -> Bool]("SDL_JoystickEventsEnabled")()
...
fn update_joysticks() -> None:
    ...
    return _get_sdl_handle()[].get_function[fn () -> None]("SDL_UpdateJoysticks")()
...
fn get_joystick_axis(joystick: Ptr[Joystick, mut=True], axis: c_int) -> Int16:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True], axis: c_int) -> Int16]("SDL_GetJoystickAxis")(joystick, axis)
...
fn get_joystick_axis_initial_state(joystick: Ptr[Joystick, mut=True], axis: c_int, state: Ptr[Int16, mut=True]) -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True], axis: c_int, state: Ptr[Int16, mut=True]) -> Bool]("SDL_GetJoystickAxisInitialState")(joystick, axis, state)
...
fn get_joystick_ball(joystick: Ptr[Joystick, mut=True], ball: c_int, dx: Ptr[c_int, mut=True], dy: Ptr[c_int, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True], ball: c_int, dx: Ptr[c_int, mut=True], dy: Ptr[c_int, mut=True]) -> Bool]("SDL_GetJoystickBall")(joystick, ball, dx, dy)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn get_joystick_hat(joystick: Ptr[Joystick, mut=True], hat: c_int) -> UInt8:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True], hat: c_int) -> UInt8]("SDL_GetJoystickHat")(joystick, hat)
...
fn get_joystick_button(joystick: Ptr[Joystick, mut=True], button: c_int) -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True], button: c_int) -> Bool]("SDL_GetJoystickButton")(joystick, button)
...
fn rumble_joystick(joystick: Ptr[Joystick, mut=True], low_frequency_rumble: UInt16, high_frequency_rumble: UInt16, duration_ms: UInt32) -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True], low_frequency_rumble: UInt16, high_frequency_rumble: UInt16, duration_ms: UInt32) -> Bool]("SDL_RumbleJoystick")(joystick, low_frequency_rumble, high_frequency_rumble, duration_ms)
...
fn rumble_joystick_triggers(joystick: Ptr[Joystick, mut=True], left_rumble: UInt16, right_rumble: UInt16, duration_ms: UInt32) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True], left_rumble: UInt16, right_rumble: UInt16, duration_ms: UInt32) -> Bool]("SDL_RumbleJoystickTriggers")(joystick, left_rumble, right_rumble, duration_ms)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn set_joystick_led(joystick: Ptr[Joystick, mut=True], red: UInt8, green: UInt8, blue: UInt8) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True], red: UInt8, green: UInt8, blue: UInt8) -> Bool]("SDL_SetJoystickLED")(joystick, red, green, blue)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn send_joystick_effect(joystick: Ptr[Joystick, mut=True], data: Ptr[NoneType, mut=False], size: c_int) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True], data: Ptr[NoneType, mut=False], size: c_int) -> Bool]("SDL_SendJoystickEffect")(joystick, data, size)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn close_joystick(joystick: Ptr[Joystick, mut=True]) -> None:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True]) -> None]("SDL_CloseJoystick")(joystick)
...
fn get_joystick_connection_state(joystick: Ptr[Joystick, mut=True]) -> JoystickConnectionState:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True]) -> JoystickConnectionState]("SDL_GetJoystickConnectionState")(joystick)
...
fn get_joystick_power_info(joystick: Ptr[Joystick, mut=True], percent: Ptr[c_int, mut=True]) -> PowerState:
    ...
    return _get_sdl_handle()[].get_function[fn (joystick: Ptr[Joystick, mut=True], percent: Ptr[c_int, mut=True]) -> PowerState]("SDL_GetJoystickPowerInfo")(joystick, percent)
