...
fn set_hint_with_priority(var name: String, var value: String, priority: HintPriority) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (name: Ptr[c_char, mut=False], value: Ptr[c_char, mut=False], priority: HintPriority) -> Bool]("SDL_SetHintWithPriority")(name.unsafe_cstr_ptr(), value.unsafe_cstr_ptr(), priority)
    if not ret:
...
fn set_hint(var name: String, var value: String) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (name: Ptr[c_char, mut=False], value: Ptr[c_char, mut=False]) -> Bool]("SDL_SetHint")(name.unsafe_cstr_ptr(), value.unsafe_cstr_ptr())
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn reset_hint(var name: String) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (name: Ptr[c_char, mut=False]) -> Bool]("SDL_ResetHint")(name.unsafe_cstr_ptr())
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn reset_hints() -> None:
    ...
    return _get_sdl_handle()[].get_function[fn () -> None]("SDL_ResetHints")()
...
fn get_hint(var name: String) -> Ptr[c_char, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn (name: Ptr[c_char, mut=False]) -> Ptr[c_char, mut=False]]("SDL_GetHint")(name.unsafe_cstr_ptr())
...
fn get_hint_boolean(var name: String, default_value: Bool) -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn (name: Ptr[c_char, mut=False], default_value: Bool) -> Bool]("SDL_GetHintBoolean")(name.unsafe_cstr_ptr(), default_value)
...
fn add_hint_callback(var name: String, callback: HintCallback, userdata: Ptr[NoneType, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (name: Ptr[c_char, mut=False], callback: HintCallback, userdata: Ptr[NoneType, mut=True]) -> Bool]("SDL_AddHintCallback")(name.unsafe_cstr_ptr(), callback, userdata)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn remove_hint_callback(var name: String, callback: HintCallback, userdata: Ptr[NoneType, mut=True]) -> None:
    ...
    return _get_sdl_handle()[].get_function[fn (name: Ptr[c_char, mut=False], callback: HintCallback, userdata: Ptr[NoneType, mut=True]) -> None]("SDL_RemoveHintCallback")(name.unsafe_cstr_ptr(), callback, userdata)
