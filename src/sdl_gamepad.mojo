...
@fieldwise_init
struct Gamepad(ImplicitlyCopyable, Movable):
...
fn add_gamepad_mapping(var mapping: String) -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn (mapping: Ptr[c_char, mut=False]) -> c_int]("SDL_AddGamepadMapping")(mapping.unsafe_cstr_ptr())
...
fn add_gamepad_mappings_from_io(src: Ptr[IOStream, mut=True], closeio: Bool) -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn (src: Ptr[IOStream, mut=True], closeio: Bool) -> c_int]("SDL_AddGamepadMappingsFromIO")(src, closeio)
...
fn add_gamepad_mappings_from_file(var file: String) -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn (file: Ptr[c_char, mut=False]) -> c_int]("SDL_AddGamepadMappingsFromFile")(file.unsafe_cstr_ptr())
...
fn reload_gamepad_mappings() raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn () -> Bool]("SDL_ReloadGamepadMappings")()
    if not ret:
...
fn get_gamepad_mappings(count: Ptr[c_int, mut=True]) -> Ptr[Ptr[c_char, mut=True], mut=True]:
    ...
    return _get_sdl_handle()[].get_function[fn (count: Ptr[c_int, mut=True]) -> Ptr[Ptr[c_char, mut=True], mut=True]]("SDL_GetGamepadMappings")(count)
...
fn get_gamepad_mapping_for_guid(guid: GUID, out ret: Ptr[c_char, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (guid: GUID) -> Ptr[c_char, mut=True]]("SDL_GetGamepadMappingForGUID")(guid)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn get_gamepad_mapping(gamepad: Ptr[Gamepad, mut=True]) -> Ptr[c_char, mut=True]:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True]) -> Ptr[c_char, mut=True]]("SDL_GetGamepadMapping")(gamepad)
...
fn set_gamepad_mapping(instance_id: JoystickID, var mapping: String) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (instance_id: JoystickID, mapping: Ptr[c_char, mut=False]) -> Bool]("SDL_SetGamepadMapping")(instance_id, mapping.unsafe_cstr_ptr())
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn has_gamepad() -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn () -> Bool]("SDL_HasGamepad")()
...
fn get_gamepads(count: Ptr[c_int, mut=True], out ret: Ptr[JoystickID, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (count: Ptr[c_int, mut=True]) -> Ptr[JoystickID, mut=True]]("SDL_GetGamepads")(count)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn is_gamepad(instance_id: JoystickID) -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> Bool]("SDL_IsGamepad")(instance_id)
...
fn get_gamepad_name_for_id(instance_id: JoystickID) -> Ptr[c_char, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> Ptr[c_char, mut=False]]("SDL_GetGamepadNameForID")(instance_id)
...
fn get_gamepad_path_for_id(instance_id: JoystickID) -> Ptr[c_char, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> Ptr[c_char, mut=False]]("SDL_GetGamepadPathForID")(instance_id)
...
fn get_gamepad_player_index_for_id(instance_id: JoystickID) -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> c_int]("SDL_GetGamepadPlayerIndexForID")(instance_id)
...
fn get_gamepad_guid_for_id(instance_id: JoystickID) -> GUID:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> GUID]("SDL_GetGamepadGUIDForID")(instance_id)
...
fn get_gamepad_vendor_for_id(instance_id: JoystickID) -> UInt16:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> UInt16]("SDL_GetGamepadVendorForID")(instance_id)
...
fn get_gamepad_product_for_id(instance_id: JoystickID) -> UInt16:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> UInt16]("SDL_GetGamepadProductForID")(instance_id)
...
fn get_gamepad_product_version_for_id(instance_id: JoystickID) -> UInt16:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> UInt16]("SDL_GetGamepadProductVersionForID")(instance_id)
...
fn get_gamepad_type_for_id(instance_id: JoystickID) -> GamepadType:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> GamepadType]("SDL_GetGamepadTypeForID")(instance_id)
...
fn get_real_gamepad_type_for_id(instance_id: JoystickID) -> GamepadType:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> GamepadType]("SDL_GetRealGamepadTypeForID")(instance_id)
...
fn get_gamepad_mapping_for_id(instance_id: JoystickID) -> Ptr[c_char, mut=True]:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> Ptr[c_char, mut=True]]("SDL_GetGamepadMappingForID")(instance_id)
...
fn open_gamepad(instance_id: JoystickID) -> Ptr[Gamepad, mut=True]:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> Ptr[Gamepad, mut=True]]("SDL_OpenGamepad")(instance_id)
...
fn get_gamepad_from_id(instance_id: JoystickID) -> Ptr[Gamepad, mut=True]:
    ...
    return _get_sdl_handle()[].get_function[fn (instance_id: JoystickID) -> Ptr[Gamepad, mut=True]]("SDL_GetGamepadFromID")(instance_id)
...
fn get_gamepad_from_player_index(player_index: c_int) -> Ptr[Gamepad, mut=True]:
    ...
    return _get_sdl_handle()[].get_function[fn (player_index: c_int) -> Ptr[Gamepad, mut=True]]("SDL_GetGamepadFromPlayerIndex")(player_index)
...
fn get_gamepad_properties(gamepad: Ptr[Gamepad, mut=True]) -> PropertiesID:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True]) -> PropertiesID]("SDL_GetGamepadProperties")(gamepad)
...
fn get_gamepad_id(gamepad: Ptr[Gamepad, mut=True]) -> JoystickID:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True]) -> JoystickID]("SDL_GetGamepadID")(gamepad)
...
fn get_gamepad_name(gamepad: Ptr[Gamepad, mut=True]) -> Ptr[c_char, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True]) -> Ptr[c_char, mut=False]]("SDL_GetGamepadName")(gamepad)
...
fn get_gamepad_path(gamepad: Ptr[Gamepad, mut=True]) -> Ptr[c_char, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True]) -> Ptr[c_char, mut=False]]("SDL_GetGamepadPath")(gamepad)
...
fn get_gamepad_type(gamepad: Ptr[Gamepad, mut=True]) -> GamepadType:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True]) -> GamepadType]("SDL_GetGamepadType")(gamepad)
...
fn get_real_gamepad_type(gamepad: Ptr[Gamepad, mut=True]) -> GamepadType:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True]) -> GamepadType]("SDL_GetRealGamepadType")(gamepad)
...
fn get_gamepad_player_index(gamepad: Ptr[Gamepad, mut=True]) -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True]) -> c_int]("SDL_GetGamepadPlayerIndex")(gamepad)
...
fn set_gamepad_player_index(gamepad: Ptr[Gamepad, mut=True], player_index: c_int) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], player_index: c_int) -> Bool]("SDL_SetGamepadPlayerIndex")(gamepad, player_index)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn get_gamepad_vendor(gamepad: Ptr[Gamepad, mut=True]) -> UInt16:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True]) -> UInt16]("SDL_GetGamepadVendor")(gamepad)
...
fn get_gamepad_product(gamepad: Ptr[Gamepad, mut=True]) -> UInt16:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True]) -> UInt16]("SDL_GetGamepadProduct")(gamepad)
...
fn get_gamepad_product_version(gamepad: Ptr[Gamepad, mut=True]) -> UInt16:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True]) -> UInt16]("SDL_GetGamepadProductVersion")(gamepad)
...
fn get_gamepad_firmware_version(gamepad: Ptr[Gamepad, mut=True]) -> UInt16:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True]) -> UInt16]("SDL_GetGamepadFirmwareVersion")(gamepad)
...
fn get_gamepad_serial(gamepad: Ptr[Gamepad, mut=True]) -> Ptr[c_char, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True]) -> Ptr[c_char, mut=False]]("SDL_GetGamepadSerial")(gamepad)
...
fn get_gamepad_steam_handle(gamepad: Ptr[Gamepad, mut=True]) -> UInt64:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True]) -> UInt64]("SDL_GetGamepadSteamHandle")(gamepad)
...
fn get_gamepad_connection_state(gamepad: Ptr[Gamepad, mut=True]) -> JoystickConnectionState:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True]) -> JoystickConnectionState]("SDL_GetGamepadConnectionState")(gamepad)
...
fn get_gamepad_power_info(gamepad: Ptr[Gamepad, mut=True], percent: Ptr[c_int, mut=True]) -> PowerState:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], percent: Ptr[c_int, mut=True]) -> PowerState]("SDL_GetGamepadPowerInfo")(gamepad, percent)
...
fn gamepad_connected(gamepad: Ptr[Gamepad, mut=True]) -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True]) -> Bool]("SDL_GamepadConnected")(gamepad)
...
fn get_gamepad_joystick(gamepad: Ptr[Gamepad, mut=True], out ret: Ptr[Joystick, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True]) -> Ptr[Joystick, mut=True]]("SDL_GetGamepadJoystick")(gamepad)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn set_gamepad_events_enabled(enabled: Bool) -> None:
    ...
    return _get_sdl_handle()[].get_function[fn (enabled: Bool) -> None]("SDL_SetGamepadEventsEnabled")(enabled)
...
fn gamepad_events_enabled() -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn () -> Bool]("SDL_GamepadEventsEnabled")()
...
fn get_gamepad_bindings(gamepad: Ptr[Gamepad, mut=True], count: Ptr[c_int, mut=True]) -> Ptr[Ptr[GamepadBinding, mut=True], mut=True]:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], count: Ptr[c_int, mut=True]) -> Ptr[Ptr[GamepadBinding, mut=True], mut=True]]("SDL_GetGamepadBindings")(gamepad, count)
...
fn update_gamepads() -> None:
    ...
    return _get_sdl_handle()[].get_function[fn () -> None]("SDL_UpdateGamepads")()
...
fn get_gamepad_type_from_string(var str: String) -> GamepadType:
    ...
    return _get_sdl_handle()[].get_function[fn (str: Ptr[c_char, mut=False]) -> GamepadType]("SDL_GetGamepadTypeFromString")(str.unsafe_cstr_ptr())
...
fn get_gamepad_string_for_type(type: GamepadType) -> Ptr[c_char, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn (type: GamepadType) -> Ptr[c_char, mut=False]]("SDL_GetGamepadStringForType")(type)
...
fn get_gamepad_axis_from_string(var str: String) -> GamepadAxis:
    ...
    return _get_sdl_handle()[].get_function[fn (str: Ptr[c_char, mut=False]) -> GamepadAxis]("SDL_GetGamepadAxisFromString")(str.unsafe_cstr_ptr())
...
fn get_gamepad_string_for_axis(axis: GamepadAxis) -> Ptr[c_char, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn (axis: GamepadAxis) -> Ptr[c_char, mut=False]]("SDL_GetGamepadStringForAxis")(axis)
...
fn gamepad_has_axis(gamepad: Ptr[Gamepad, mut=True], axis: GamepadAxis) -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], axis: GamepadAxis) -> Bool]("SDL_GamepadHasAxis")(gamepad, axis)
...
fn get_gamepad_axis(gamepad: Ptr[Gamepad, mut=True], axis: GamepadAxis) -> Int16:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], axis: GamepadAxis) -> Int16]("SDL_GetGamepadAxis")(gamepad, axis)
...
fn get_gamepad_button_from_string(var str: String) -> GamepadButton:
    ...
    return _get_sdl_handle()[].get_function[fn (str: Ptr[c_char, mut=False]) -> GamepadButton]("SDL_GetGamepadButtonFromString")(str.unsafe_cstr_ptr())
...
fn get_gamepad_string_for_button(button: GamepadButton) -> Ptr[c_char, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn (button: GamepadButton) -> Ptr[c_char, mut=False]]("SDL_GetGamepadStringForButton")(button)
...
fn gamepad_has_button(gamepad: Ptr[Gamepad, mut=True], button: GamepadButton) -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], button: GamepadButton) -> Bool]("SDL_GamepadHasButton")(gamepad, button)
...
fn get_gamepad_button(gamepad: Ptr[Gamepad, mut=True], button: GamepadButton) -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], button: GamepadButton) -> Bool]("SDL_GetGamepadButton")(gamepad, button)
...
fn get_gamepad_button_label_for_type(type: GamepadType, button: GamepadButton) -> GamepadButtonLabel:
    ...
    return _get_sdl_handle()[].get_function[fn (type: GamepadType, button: GamepadButton) -> GamepadButtonLabel]("SDL_GetGamepadButtonLabelForType")(type, button)
...
fn get_gamepad_button_label(gamepad: Ptr[Gamepad, mut=True], button: GamepadButton) -> GamepadButtonLabel:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], button: GamepadButton) -> GamepadButtonLabel]("SDL_GetGamepadButtonLabel")(gamepad, button)
...
fn get_num_gamepad_touchpads(gamepad: Ptr[Gamepad, mut=True]) -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True]) -> c_int]("SDL_GetNumGamepadTouchpads")(gamepad)
...
fn get_num_gamepad_touchpad_fingers(gamepad: Ptr[Gamepad, mut=True], touchpad: c_int) -> c_int:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], touchpad: c_int) -> c_int]("SDL_GetNumGamepadTouchpadFingers")(gamepad, touchpad)
...
fn get_gamepad_touchpad_finger(gamepad: Ptr[Gamepad, mut=True], touchpad: c_int, finger: c_int, down: Ptr[Bool, mut=True], x: Ptr[c_float, mut=True], y: Ptr[c_float, mut=True], pressure: Ptr[c_float, mut=True]) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], touchpad: c_int, finger: c_int, down: Ptr[Bool, mut=True], x: Ptr[c_float, mut=True], y: Ptr[c_float, mut=True], pressure: Ptr[c_float, mut=True]) -> Bool]("SDL_GetGamepadTouchpadFinger")(gamepad, touchpad, finger, down, x, y, pressure)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn gamepad_has_sensor(gamepad: Ptr[Gamepad, mut=True], type: SensorType) -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], type: SensorType) -> Bool]("SDL_GamepadHasSensor")(gamepad, type)
...
fn set_gamepad_sensor_enabled(gamepad: Ptr[Gamepad, mut=True], type: SensorType, enabled: Bool) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], type: SensorType, enabled: Bool) -> Bool]("SDL_SetGamepadSensorEnabled")(gamepad, type, enabled)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn gamepad_sensor_enabled(gamepad: Ptr[Gamepad, mut=True], type: SensorType) -> Bool:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], type: SensorType) -> Bool]("SDL_GamepadSensorEnabled")(gamepad, type)
...
fn get_gamepad_sensor_data_rate(gamepad: Ptr[Gamepad, mut=True], type: SensorType) -> c_float:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], type: SensorType) -> c_float]("SDL_GetGamepadSensorDataRate")(gamepad, type)
...
fn get_gamepad_sensor_data(gamepad: Ptr[Gamepad, mut=True], type: SensorType, data: Ptr[c_float, mut=True], num_values: c_int) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], type: SensorType, data: Ptr[c_float, mut=True], num_values: c_int) -> Bool]("SDL_GetGamepadSensorData")(gamepad, type, data, num_values)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn rumble_gamepad(gamepad: Ptr[Gamepad, mut=True], low_frequency_rumble: UInt16, high_frequency_rumble: UInt16, duration_ms: UInt32) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], low_frequency_rumble: UInt16, high_frequency_rumble: UInt16, duration_ms: UInt32) -> Bool]("SDL_RumbleGamepad")(gamepad, low_frequency_rumble, high_frequency_rumble, duration_ms)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn rumble_gamepad_triggers(gamepad: Ptr[Gamepad, mut=True], left_rumble: UInt16, right_rumble: UInt16, duration_ms: UInt32) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], left_rumble: UInt16, right_rumble: UInt16, duration_ms: UInt32) -> Bool]("SDL_RumbleGamepadTriggers")(gamepad, left_rumble, right_rumble, duration_ms)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn set_gamepad_led(gamepad: Ptr[Gamepad, mut=True], red: UInt8, green: UInt8, blue: UInt8) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], red: UInt8, green: UInt8, blue: UInt8) -> Bool]("SDL_SetGamepadLED")(gamepad, red, green, blue)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn send_gamepad_effect(gamepad: Ptr[Gamepad, mut=True], data: Ptr[NoneType, mut=False], size: c_int) raises:
    ...
    ret = _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], data: Ptr[NoneType, mut=False], size: c_int) -> Bool]("SDL_SendGamepadEffect")(gamepad, data, size)
    if not ret:
        raise Error(String(unsafe_from_utf8_ptr=get_error()))
...
fn close_gamepad(gamepad: Ptr[Gamepad, mut=True]) -> None:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True]) -> None]("SDL_CloseGamepad")(gamepad)
...
fn get_gamepad_apple_sf_symbols_name_for_button(gamepad: Ptr[Gamepad, mut=True], button: GamepadButton) -> Ptr[c_char, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], button: GamepadButton) -> Ptr[c_char, mut=False]]("SDL_GetGamepadAppleSFSymbolsNameForButton")(gamepad, button)
...
fn get_gamepad_apple_sf_symbols_name_for_axis(gamepad: Ptr[Gamepad, mut=True], axis: GamepadAxis) -> Ptr[c_char, mut=False]:
    ...
    return _get_sdl_handle()[].get_function[fn (gamepad: Ptr[Gamepad, mut=True], axis: GamepadAxis) -> Ptr[c_char, mut=False]]("SDL_GetGamepadAppleSFSymbolsNameForAxis")(gamepad, axis)
